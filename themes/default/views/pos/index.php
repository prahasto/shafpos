                ...
                <table style="width:100%;" class="layout-table">
                    ...
                    <div id="pos">
                        ...
                        <div class="well well-sm" id="leftdiv">
                            ...
                            <input type="submit" id="submit" value="Submit Sale" hidden="true"  />
                        </div>
                        <?=form_close();?>
                </td>  <!-- end td-->
                        ...
                        <div class="row ">
                            ...
                            <div class="col-xs-12">
                                <div id="list-tablepayment-div">
                                    ...
                                    <table id="posTableAddPayment" class="   table-condensed  list-table" style="margin:0px;" data-height="70">
                                        <thead>
                                        <tr class="success">
                                            <th style="width: 20%;text-align:left;"></th>
                                            <th style="width: 15%;text-align:left;"></th>
                                            <th style="width: 7%;text-align:left;"></th>
                                            <th style="width: 19%;text-align:left;"></th>
                                ...
                                <div style="clear:both;"></div>
                                <table hidden id="posTableAddPayments" class="  table-bordered table-condensed" style="margin-bottom: 0;">
                                    <thead>
                                    <tr class="success">
                                        <th style="width: 20%;text-align:left;"></th>
                                        <th style="width: 15%;text-align:left;"></th>
...
<div class="modal" data-easein="flipYIn" id="posRetur" tabindex="-1" role="dialog" aria-labelledby="cModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-primary">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
            ...
            <!-- <?= form_open('pos/add_retur', 'id="pos-retur-form"'); ?> -->
            <form id="pos-retur-form">
                <div class="modal-body">
                    <div id="c-alert" class="alert alert-danger" style="display:none;"></div>
                    <div class="well well-sm" id="leftdiv">
                        <div id="lefttop" style="margin-bottom:5px;">
                            <div class="form-group" style="margin-bottom:5px;">
                                <input type="text" name="searchsalesno" id="searchsalesno" class="form-control ui-autocomplete-input" placeholder="Search Sales No..." autocomplete="on">
                                <input type="hidden" name="salesidmodalpayment" id="salesidmodalpayment" value=""/>
                            </div>
                            <?php if ($eid && $Admin) { ?>
                                <div class="form-group" style="margin-bottom:5px;">
                                    <?= form_input('date', set_value('date', $sale->date), 'id="date" required="required" class="form-control"'); ?>
                            ...
                            <?php } ?>
                            <div class="form-group" style="margin-bottom:5px;">
                                <input type="text" disabled="true" name="custnamemodalretur" value="" id="custnamemodalretur" class="form-control kb-text" placeholder="Customer Name" />
                            </div>
                            <div class="form-group" style="margin-bottom:5px;">
                                <input type="text" name="code" id="add_item" class="form-control" placeholder="<?=lang('search__scan')?>" />
                            </div>
                        ...
                        <div id="print" class="fixed-table-container">
                            <div id="list-table-div">
                                ...
                                <table id="posTableItemRetur" class="table table-striped table-condensed table-hover list-table" style="margin:0px;" data-height="100">
                                    <thead>
                                    <tr class="success">
                                        <th style="width: 20%;text-align:left;"><?=lang('product')?></th>
                                        <th style="width: 15%;text-align:left;"><?=lang('price')?></th>
                        ...
                        <input type="hidden" name="total_items" id="total_items" value="0" />
                        <input type="hidden" name="total_quantity" id="total_quantity" value="0" />
                        <input type="hidden" id="submitretur" value="Submit Sale" />
