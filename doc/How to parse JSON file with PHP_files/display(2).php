...
var builder = new ReopenUrlBuilder("http:\/\/www.tradeadexchange.com\/a\/display.php?r=410823&treqn=1117877498&runauction=1&crr=0b6ea03a5eead145ef66whGctgGdpdXLlxWam1ibvNnatU2cyFGct8Gdtc3bo1Cd19mYh1CbhlmcvRXd0ZkMl02bj5iclB3bsVmdlRmYldXZi5yd3dnRyUiRyUSQzUCc0RHa8b1d573633a9304861ec&rtid=5a1cdcfb2dff8");
var url = builder.build();

    var content = '<iframe width="300" height="250" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5a1cdcfb2dff8"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5a1cdcfb2dff8').removeAttribute('sandbox');
    }
