...
var builder = new ReopenUrlBuilder("http:\/\/www.tradeadexchange.com\/a\/display.php?r=410822&treqn=476015595&runauction=1&crr=959fabe0d8c09c531553Pf9zSe9yWjskaPt1ZLZ0Qzc1SqNzN79zSC9ySiM0XL5yKDd3eL50ebdzQvsyLnfjaKN0cHZza_M0Trdyavd3ajs2dHJyIjc-NqZ-Nqp_Mq5zLv81710baaab43bec90bd896&rtid=5a1cdcfb306d2");
var url = builder.build();

    var content = '<iframe width="300" height="250" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5a1cdcfb306d2"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5a1cdcfb306d2').removeAttribute('sandbox');
    }
