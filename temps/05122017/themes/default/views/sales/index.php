...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#SLData').DataTable({
            ...
            "columns": [
                { "data": "id", "visible": false, "class" :"id" },
                { "data": "salesno","class" :"salesno" },
                    ...
                    <div class="table-responsive">
                        <table id="SLData" class="table  table-striped table-bordered table-condensed table-hover">
                            ...
                            <tr class="active">
                                ...
                                <th class="col-sm-2"><input type="text" class="text_filter" placeholder="[Sales No]"></th>
                                ...
                                <th class="col-sm-1">
                                    <select class="select2 select_filter"><option value=""><?= lang("all"); ?></option><option value="paid"><?= lang("paid"); ?></option><option value="Void">Void</option></select>
                                </th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php $opts = array('paid' => lang('paid'), 'void' => lang('Void'))  ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.sale_status', function() {
                ...
                var sale_id = $(this).closest('tr').find('.salesno').text();
                var saleno = $(this).closest('tr').find('.salesno').text();
                var curr_status = $(this).closest('tr').find('.statussales').text();
                var status = curr_status.toLowerCase();
                //alert("sale id: " + sale_id );
                //alert(curr_status);
                if (curr_status != 'Void') {
                    $('#sales-no').text('(Sales No ' + saleno + ' )');
                    $('#sale_id').val(sale_id);
                    $('#status').val(status);
